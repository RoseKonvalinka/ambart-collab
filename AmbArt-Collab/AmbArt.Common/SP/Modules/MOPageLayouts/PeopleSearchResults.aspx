...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
		<asp:literal runat="server" Text="<%$Resources:Microsoft.Office.Server.Search, Search_People_Results_Page_Title%>"/> 
...
<ContentTemplate>
                   <div class="srch-maintoppeople2">
                  	             ...
                  	             <SharePoint:UIVersionedContent UIVersion="3" runat="server"> <ContentTemplate> <table border="0" cellpadding="0" cellspacing="0" width="100%"> 
	<tbody>
		<tr width="100%"> <td class="srch-refineareao12"> <SEARCHWC:PeopleRefinementWebPart ChromeType="None" runat="server" /> </td> <td width="100%"> </ContentTemplate> </SharePoint:UIVersionedContent> 
			...
			<SharePoint:UIVersionedContent UIVersion="3" runat="server"> <ContentTemplate> </td> </tr> </table> </ContentTemplate> </SharePoint:UIVersionedContent>
